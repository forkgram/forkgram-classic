...
public class UpdateAppAlertDialog extends BottomSheet {
    ...
    public UpdateAppAlertDialog(Context context, TLRPC.TL_help_appUpdate update, int account) {
        ...
        container.addView(optionsButton, LayoutHelper.createFrame(40, 40, Gravity.TOP | Gravity.RIGHT, 0, 5, 5, 0));
        optionsButton.addSubItem(1, R.drawable.msg_cancel, LocaleController.getString(R.string.AppUpdateSkipVersion));
        optionsButton.setOnClickListener(v -> optionsButton.toggleSubMenu());
        optionsButton.setDelegate(id -> {
            if (id == 1) {
                SharedConfig.skipPendingAppUpdate();
