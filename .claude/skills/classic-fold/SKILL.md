...
JAVA_HOME=/usr/lib/jvm/temurin-21-jdk ANDROID_HOME=/opt/android-sdk ./gradlew :TMessagesProj_App:assembleAfatDebug -PF_DROID=1 --console=plain 2>&1 | grep -E "BUILD (SUCCESSFUL|FAILED)|error:"
```
