...
//            }
        ...
        textFieldContainer.addView(aiButton, LayoutHelper.createFrame(48, 48, Gravity.TOP | Gravity.RIGHT, 0, 1, 0, 0));
...
//        });
    ...
    // forkgram-classic: upstream PeerStoriesView wires a long-press handler
    // on the send button for "send as" picker. Classic enter view already
    // owns the long-press behaviour internally — accept and drop.
...
//        }
    ...
    private void showAiButton(boolean show_) {
        final boolean show = show_ && aiButton != null && parentFragment != null && !parentFragment.isSecretChat() && !MessagesController.getGlobalMainSettings().getBoolean("hideAiEditor", false);
