...
public class SideMenultItemAnimator extends SimpleItemAnimator {
    ...
    // forkgram-classic: AndroidX RecyclerView 1.x exposed an abstract
    // listenToAnimationUpdates hook on ItemAnimator (post 1.2 ItemAnimator
    // refactor). The classic side-menu animator doesn't drive a callback
    // ticker, so accept the listener and ignore.
    @Override
    public void listenToAnimationUpdates(Runnable runnable) {
    }
}
