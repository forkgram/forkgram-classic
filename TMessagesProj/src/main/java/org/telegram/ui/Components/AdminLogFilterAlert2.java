...
public class AdminLogFilterAlert2 extends BottomSheetWithRecyclerListView {
    ...
    public AdminLogFilterAlert2(BaseFragment fragment, TLRPC.TL_channelAdminLogEventsFilter filter, LongSparseArray<TLRPC.User> admins, boolean megagroup) {
        ...
        topPadding = 0.35f;
        fixNavigationBar();
        // [classic] #28: classic flat dialog background (11.9.5.0) — no gray sections canvas.
        setSlidingActionBar();
        setShowHandle(true);
        ...
        buttonContainer.setBackgroundColor(Theme.getColor(Theme.key_dialogBackground, resourcesProvider)); // [classic] #28: classic button panel bg (11.9.5.0)
        actionButton = new ButtonWithCounterView(getContext(), resourcesProvider);
        // [classic] #28: classic 8dp-radius Apply Filter button (11.9.5.0) — no pill setRound().
        ...
        // [classic] #28: no rounded section cards (11.9.5.0) — flat classic sheet.
    }
...
//            saveScrollPosition();
    ...
    public void fillItems(ArrayList<UItem> items, UniversalAdapter adapter) {
        ...
        // [classic] #28: no leading sections-gap shadow (11.9.5.0).
