...
public class AutoDeleteMessagesActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        // [classic] #43: revert the redesign SectionsScrollView (rounded inset cards) to the classic flat ScrollView list.
        ...
        TextInfoPrivacyCell textInfoPrivacyCell = new TextInfoPrivacyCell(context); // [classic] #43: classic constructor (no card-gap padding).
