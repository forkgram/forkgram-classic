...
public class ChatActivityMemberRequestsDelegate {
    ...
    // its content view — no upstream topPanelLayout hosts it or paints its
    // background, and nothing wires a ChangeVisibilityDelegate. Keep the
    // onLayoutChanged callback and drive visibility and background from it.
